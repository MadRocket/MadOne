    ...
    */
	function registerUtilities() {
	    if( ! $this->utilities_registered )
	    {
	        ...
	        function Q( $params )           { return new Storm_Qc( $params ); }
	        function QOR( $left, $right )   { return new Storm_Qc_Or( $left, $right ); }
	        function QAND( $left, $right )  { return new Storm_Qc_And( $left, $right ); }
