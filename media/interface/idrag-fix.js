...
jQuery.iDrag =	{
	...
	//Since 1.2.x  jQuery.empty() Kills Event Binding
	// So we have a 'customized' empty Function :
	iDragEmpty: function(jqObject) {
		// Remove element nodes and prevent memory leaks
		jQuery( ">*", jqObject ).each(function(){
		...
		while ( jqObject.firstChild )
			jqObject.removeChild( jqObject.firstChild );
	},
	//-------------------------------------------------------
	destroy : function()
	{
	...
	dragstart : function(e)
	{
		...
		jQuery.iDrag.iDragEmpty(jQuery.iDrag.helper);
		//-----------------------------------------------
	...
	hidehelper : function(dragged)
	{
		...
		jQuery.iDrag.iDragEmpty(jQuery.iDrag.helper);
		jQuery.iDrag.helper.hide().css('opacity', 1);
		//----------------------------------------------------
		if (window.ActiveXObject) {
	...
	build : function(o)
	{
		...
		return this.each(
			function()
			{
				...
				var el = this;				
				//correction : http://dev.jquery.com/ticket/1409
				//var dhe = o.handle ? jQuery(this).find(o.handle) : jQuery(this);
				if (jQuery.browser.msie && typeof(o.handle)!='string') { var dhe=jQuery(o.handle); }
