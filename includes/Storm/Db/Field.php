...
abstract class Storm_Db_Field
{
	...
	protected $valueClassname = 'Storm_Db_Field_Value'; // Имя класса значений
    ...
    */
    function __construct( array $params = array() )
    {
        ...
        {
            if( $k == 'value' ) throw new Storm_Exception( "Can't set field value through constructor" );
            if( property_exists( $this, $k ) ) $this->$k = $v;
        }
        
		$this->value = new Storm_Db_Field_Value_Storage( $this->localized );
    ...
    */
    ...
    {
        if( ! property_exists( $this, $name ) ) throw new Storm_Exception( "Unknown property '{$name}'" );
    ...
    */
    function setValue( $value, $language = null )
    {
        ...
        {
            throw new Storm_Exception_Validation( "Cannot be null", $this );
        }
