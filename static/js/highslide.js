...
zIndexCounter : 300, // adjust to other absolutely positioned elements
slideInOutline : true, // whether the outline should appear at once or slide in
fullExpandTitle : 'К исходному размеру',
	...
	for (i = 0; i < aTags.length; i++) {
		...
		if (hs.isHsAnchor(a)) {
			if (j < this.numberOfImagesToPreload) {
				hs.preloadTheseImages[j] = hs.getSrc(a); //a.rel.replace(/_slash_/g, '/') || a.href;
				j++;
			}
		}
	}
