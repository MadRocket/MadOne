...
class Madone_Module_Gallery_Application extends Madone_Application {
    ...
    public function index() {
        ...
        return $this->render('gallery/index.twig', array('items' => $items, 'paginator' => $paginator, ));
    }
    ...
    public function category($slug) {
        ...
        return $this->render('gallery/category.twig', array('category' => $category,'items' => $items, 'paginator' => $paginator, ));
    }
}